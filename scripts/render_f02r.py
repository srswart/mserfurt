"""Render f02r — recto, leaf 2.  Modest private manuscript layout."""
...
FOLIO_JSON  = ROOT / "output-live" / "f02r.json"
RENDER_OUT  = ROOT / "render-output" / "f02r.png"
DEBUG_DIR   = ROOT / "debug" / "f02r_page"
...
def save_progress(label):
    ...
    img.save(str(DEBUG_DIR / f"f02r_{label}.png"), dpi=(DPI, DPI))
    img.save(str(DESKTOP / "f02r_page.png"),        dpi=(DPI, DPI))
